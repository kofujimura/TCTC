...
Here's a simple example of using `ERC-7303` in an xref:tokens.adoc#ERC721[`ERC-721`] token to define a 'minter' and 'burner' role, which allows accounts that have it create new tokens and destroy existing tokens by specifying the controll token:
