...
link:contracts/TokenController.sol[TokenController.sol] is the contract that provides xref:api:access.adoc#Roles[`Roles`] for implementing role-based access control.
